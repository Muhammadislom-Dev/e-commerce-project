      ...
      <div className="blok">
        ...
        <div className="blok__right">
          ...
          <div className="blok__right_icons">
            ...
            <div className="icons__oblast">
              <img src={clock} alt="clock" className="icons__oblast_location" />
          ...
          <p className="blok__right_note">
            <b className="note__span">Muhim eslatma:</b> Qo’ngiroq qilish uchun
            1 oyga 10 ta limit beriladi va kunlik limit 3 ta. Undan tashqari
